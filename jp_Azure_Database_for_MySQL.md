<div style="font-size:32px; color:#000000; text-align: center;font-weight:bold;">Azure Database for MySQL</div>
...
<div style="background-color:#E5F1FB; padding:0px; border:2px solid #C7E0F4;">
  ...
  <p style="color:#000000; font-size:12px; margin:10px 0; padding-left:10px;">・本資料は2026年時点のサービス内容および料金を解説しています。<br>・最新情報はMicrosoft Azure公式ウェブサイトをご確認ください。<br>・本資料の料金と公式サイトに差異がある場合は、公式サイトの料金が優先されます。<br><a href="https://learn.microsoft.com/en-us/azure/mysql/" target="_blank" style="color:#0078D4;font-size:15px; padding-left:12px;">https://learn.microsoft.com/en-us/azure/mysql/</a></p>
</div>
...
<ul style="list-style:none; padding-left:0;">
  ...
  <li style="margin-bottom:8px;"><span style="color:#0078D4; margin:0 6px 0 10px;">▶</span>MySQLの基礎知識（エンジン・レプリケーション）</li>
...
<ul style="list-style:none; padding-left:0;">
  <li style="margin-bottom:8px;"><span style="color:#0078D4; margin:0 6px 0 10px;">▶</span>OSSのMySQLをマネージドで運用したいデータベース管理者・開発者</li>
  <li style="margin-bottom:8px;"><span style="color:#0078D4; margin:0 6px 0 10px;">▶</span>Azure Database for MySQLの基礎を理解したい方</li>
  <li style="margin-bottom:8px;"><span style="color:#0078D4; margin:0 6px 0 10px;">▶</span>オンプレミスやAWS RDS for MySQLからの移行を検討する方</li>
</ul>
<div style="background-color:#FFFFFF; padding:10px;"><p style="margin:10px 0;"></p></div>
...
<div style="background-color:#FAFAFA; padding:0px; border:1px solid #C7E0F4; border-radius:8px;">
  <p style="color:#333333; font-size:18px; margin:30px 0; padding-left:30px;">1. Azure Database for MySQLとは？<br>2. デプロイモデル<br>3. コンピューティングティア<br>4. 主要機能<br>5. 料金<br>6. まとめ</p>
</div>
<div style="background-color:#FFFFFF; padding:10px;"><p style="margin:10px 0;"></p></div>
<div style="background-color:#F3F2F1; padding:0px; border-left:6px solid #0078D4;"><p style="color:#000000; font-size:25px; font-weight:bold; margin:40px 10; padding-left:10px;">1. Azure Database for MySQLとは？</p></div>

コミュニティ版MySQLサーバーエンジンをベースにした<strong>フルマネージドリレーショナルデータベースPaaS</strong>です。
現行の提供形態は「Flexible Server」で、パッチ適用・バックアップ・高可用性などの運用作業をAzureが担い、既存のMySQLアプリケーションをそのまま移行できる高い互換性を備えています。

<h4 style="color:#0078D4; border-bottom:3px solid #E5F1FB; padding-bottom:6px;">主要機能</h4>
<ul style="list-style:none; padding-left:0;">
  <li style="margin-bottom:8px;"><span style="color:#0078D4; margin:0 6px 0 10px;">▶</span><span style="font-weight:bold;">MySQLとの高い互換性：</span>標準のMySQLクライアント・ツール・ドライバーをそのまま利用できます。</li>
  <li style="margin-bottom:8px;"><span style="color:#0078D4; margin:0 6px 0 10px;">▶</span><span style="font-weight:bold;">柔軟なメンテナンス制御：</span>サーバーパラメータの細かな調整やメンテナンスウィンドウの指定が可能です。</li>
  <li style="margin-bottom:8px;"><span style="color:#0078D4; margin:0 6px 0 10px;">▶</span><span style="font-weight:bold;">ゾーン冗長高可用性：</span>可用性ゾーンをまたいだ同期スタンバイレプリカにより高い耐障害性を実現します。</li>
...
<table style="border-collapse:collapse; width:100%; margin-top:20px;">
  ...
  <tbody>
    ...
    <tr><td style="border:1px solid #C7E0F4; padding:8px;"><strong>Single Server（旧モデル）</strong></td><td style="border:1px solid #C7E0F4; padding:8px;">シンプルな管理画面を持つ旧世代モデル。新規利用は非推奨でFlexible Serverへの移行が案内されています</td></tr>
  </tbody>
</table>
<div style="background-color:#FFFFFF; padding:10px;"><p style="margin:10px 0;"></p></div>
...
<table style="border-collapse:collapse; width:100%; margin-top:20px;">
  ...
  <tbody>
    ...
    <tr style="background-color:#F3F2F1;"><td style="border:1px solid #C7E0F4; padding:8px;"><strong>Business Critical</strong></td><td style="border:1px solid #C7E0F4; padding:8px;">高IOPS・低レイテンシが必要なミッションクリティカルワークロード向け</td></tr>
  </tbody>
</table>
<div style="background-color:#FFFFFF; padding:10px;"><p style="margin:10px 0;"></p></div>
...
<ul style="list-style:none; padding-left:0;">
  <li style="margin-bottom:8px;"><span style="color:#0078D4; margin:0 6px 0 10px;">▶</span><span style="font-weight:bold;">サーバー停止/開始：</span>Flexible Serverでは開発・検証用サーバーを一時停止することでコンピューティング課金を止められます。</li>
  ...
  <li style="margin-bottom:8px;"><span style="color:#0078D4; margin:0 6px 0 10px;">▶</span><span style="font-weight:bold;">プライベートネットワーク統合：</span>VNet統合またはプライベートエンドポイントによるセキュアな接続が可能です。</li>
...
<ul style="list-style:none; padding-left:0;">
  <li style="margin-bottom:8px;"><span style="color:#0078D4; margin:0 6px 0 10px;">▶</span><strong>コンピューティング：</strong>選択したティア（Burstable/General Purpose/Business Critical）とvCore数に基づく時間課金。</li>
...
<ul style="list-style:none; padding-left:0; margin-top:10px;">
  <li style="margin-bottom:8px;"><span style="color:#0078D4; margin:0 6px 0 10px;">▶</span>Azure Database for MySQLは<strong>OSS MySQL互換のフルマネージドデータベース</strong>。既存資産をそのまま移行できます。</li>
  ...
  <li style="margin-bottom:8px;"><span style="color:#0078D4; margin:0 6px 0 10px;">▶</span>ワークロードに応じて<strong>Burstable〜Business Criticalまで3段階</strong>のティアから選択できます。</li>
